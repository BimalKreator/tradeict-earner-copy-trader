...
export declare function fetchCosmicOpenPositions(cosmicEmail: string, cosmicPassword: string, scraperMappingsJson?: unknown): Promise<CosmicLedTrade[]>;
/** Admin probe: same scrape plus optional JPEG screenshot of the logged-in viewport. */
export declare function probeCosmicOpenPositions(cosmicEmail: string, cosmicPassword: string, captureScreenshot: boolean, scraperMappingsJson?: unknown): Promise<{
