...
export async function runScraperStudioInspect(args) {
    ...
    try {
        ...
        const elements = await page.evaluate((maxEls, maxText) => {
            function esc(s) {
            ...
            function cssPath(el) {
                ...
                while (node && node !== root && node.nodeType === Node.ELEMENT_NODE) {
                    ...
                    const same = [...parent.children].filter((c) => c.tagName === htmlEl.tagName);
...
//# sourceMappingURL=scraperStudioInspect.js.map