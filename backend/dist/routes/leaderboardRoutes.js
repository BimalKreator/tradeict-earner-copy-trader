...
export function createLeaderboardRoutes(prisma) {
    const router = Router();
    router.get("/", async (_req, res, next) => {
        try {
            ...
            const strategyMetaById = new Map(strategiesMeta.map((s) => [s.id, s]));
            const strategyRows = [];
            ...
            strategyRows.sort((a, b) => b.monthlyRoiPercent - a.monthlyRoiPercent);
