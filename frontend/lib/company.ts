/** Public company & support details (Razorpay / compliance). */
export const COMPANY = {
  legalName: "Tradeict AI Private Limited",
  ...
  addressShort: "Tradeict AI Private Limited, Kanpur, Uttar Pradesh, India - 208011",
